  ...
  <div>
    <div v-if="settings" class="">
      ...
      <div v-if="settings.homepageimage === false">
        ...
        <div
          class="container animate-fade animate-once animate-delay-[500ms] mt-10 mb-20"
        >
          <div class="text-xl font-bold">{{ settings.homepage_title }}</div>
          <div v-if="settings.homepage_subtitle" class="text-xl font-bold">
            ...
            <NuxtLink to="https://github.com/bureaupixel/" target="_blank">
              ...
              <div class="">
                <span class="text-xs opacity-80 leading-tight"
                  >This dataset is based on a Bureaupixel Github repository with
                  a MIT License. Feel free to download and install it on your
                  local machine.</span
                >
              </div>
            </NuxtLink>
