<template>
  <ClientOnly>
    <div class="layout3">
      ...
      <!-- Main section-->
      <div class="layout3width mx-auto p-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          <!-- First column -->
          <div class="">
            <h1
              class="pagetitle text-4xl md:text-3xl lg:text-6xl lg:mb-10 font-bold"
            >
              {{ data.title }}
            </h1>
            <p
              class="contenthead text-lg md:text-2xl lg:text-xl pb-10 font-bold"
            >
              {{ data.description }}
            </p>
            <div
